...
setupMock({
  setup() {
    // 最新项目
    Mock.mock(new RegExp('/pms/user/my-project/list'), () => {
      const contributors = [
        {
          name: '秦臻宇',
    ...
    // 最新动态
    Mock.mock(new RegExp('/pms/user/latest-activity'), () => {
      return successResponseWrap(
    ...
    // 访问量
    Mock.mock(new RegExp('/pms/user/visits'), () => {
      return successResponseWrap([
        {
          name: '主页访问量',
          visits: 5670,
    ...
    // 项目和团队列表
    Mock.mock(new RegExp('/pms/user/project-and-team/list'), () => {
      return successResponseWrap([
        {
          id: 1,
          content: '他创建的项目',
    ...
    // 团队列表
    Mock.mock(new RegExp('/pms/user/my-team/list'), () => {
      return successResponseWrap([
        {
          id: 1,
          avatar:
